...
export default function AddRuleModal({ isOpen, onClose, onSuccess, editRule = null, prefillData = null }) {
        ...
        if (isOpen) {
            ...
            if (editRule) {
                setFormData({
                    ...
                    mainDishId: editRule.mainDishId?._id || editRule.mainDishId || '',
                    secondaryDishId: editRule.secondaryDishId?._id || editRule.secondaryDishId || '',
                ...
                setFormData(prev => ({
                    ...prev,
                    ...prefillData,
                    mainDishId: prefillData.mainDishId || '',
                    secondaryDishId: prefillData.secondaryDishId || '',
                }));
            }
        }
    }, [isOpen, editRule, prefillData]);
    ...
    return (
        <Modal
            title={editRule ? 'Edit Rule' : 'Add New Rule'}
            onClose={handleClose}
            size="2xl"
        >
