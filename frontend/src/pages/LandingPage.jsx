...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-slate-50 font-sans text-slate-900 selection:bg-indigo-100 selection:text-indigo-900 relative flex flex-col overflow-x-hidden">
      {/* Background Decor - Fixed to viewport */}
      ...
      {/* Main Content */}
      <main className="relative z-10 flex-grow flex flex-col items-center px-6 sm:px-8 lg:px-12 py-4">
