          ...
          <div className="p-6">
            {loading ? (
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 mt-3">Loading dishes...</p>
              </div>
            ) : filteredDishes.length === 0 ? (
              <div className="text-center py-12 border-2 border-dashed border-amber-200 rounded-lg bg-amber-50">
                ...
                <h3 className="text-lg font-semibold text-gray-700 mb-2">
                  {dishes.length === 0 ? 'No dishes yet' : 'No dishes found'}
                </h3>
