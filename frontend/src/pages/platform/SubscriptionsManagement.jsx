          ...
          <div className="bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm">
            <div className="overflow-x-auto">
              <table className="min-w-full text-sm">
                <thead className="bg-slate-50 border-b border-slate-200">
                  <tr>
                    <th className="text-left px-4 py-3 font-medium text-slate-600 whitespace-nowrap">Restaurant</th>
                    <th className="text-left px-4 py-3 font-medium text-slate-600 whitespace-nowrap">Plan</th>
                    <th className="text-left px-4 py-3 font-medium text-slate-600 whitespace-nowrap">Cycle</th>
                    <th className="text-left px-4 py-3 font-medium text-slate-600 whitespace-nowrap">Expiry</th>
            ...
            {sortedRestaurants.length > 0 && (
              <div className="block sm:hidden bg-slate-50 px-4 py-2 text-xs text-slate-500 text-center border-t border-slate-200">
                ← Scroll horizontally to see Status & Actions →
              </div>
            )}
          </div>
        </div>
